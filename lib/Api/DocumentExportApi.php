...
class DocumentExportApi
{
     ...
     *
     * @param  \BillingoClientAPIv3\Client\Model\CreateDocumentExport $body Create document export body. (required)
     *
     * @throws \BillingoClientAPIv3\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BillingoClientAPIv3\Client\Model\DocumentExportId
     */
     ...
     * @throws \BillingoClientAPIv3\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BillingoClientAPIv3\Client\Model\DocumentExportId, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWithHttpInfo($body)
    {
        $returnType = '\BillingoClientAPIv3\Client\Model\DocumentExportId';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BillingoClientAPIv3\Client\Model\DocumentExportId',
     ...
     * @throws \BillingoClientAPIv3\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BillingoClientAPIv3\Client\Model\DocumentExportStatus
     */
     ...
     * @throws \BillingoClientAPIv3\Client\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \BillingoClientAPIv3\Client\Model\DocumentExportStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function pollWithHttpInfo($id)
    {
        $returnType = '\BillingoClientAPIv3\Client\Model\DocumentExportStatus';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\BillingoClientAPIv3\Client\Model\DocumentExportStatus',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
